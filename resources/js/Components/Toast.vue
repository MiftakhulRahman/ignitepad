...
<template>
    ...
    >
        ...
        <div v-if="show" class="fixed top-24 right-6 z-50 flex w-full max-w-md overflow-hidden bg-white rounded-xl shadow-2xl border border-gray-100">

            <div class="flex items-center justify-center w-16" :class="type === 'success' ? 'bg-green-500' : 'bg-red-500'">
            ...
            <div class="px-6 py-4 flex-1">
                ...
                <span class="font-bold text-lg block mb-1" :class="type === 'success' ? 'text-green-600' : 'text-red-600'">
